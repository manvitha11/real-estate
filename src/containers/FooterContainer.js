  ...
  return (
    <Footer>
      <Footer.Container>
        <Footer.Content>w
          <Footer.Item>
            <Footer.Title>Devesh Homes</Footer.Title>
            <Footer.Text>
              India, Andhra pradesh , near katheru, Rajahmundry.
            </Footer.Text>
            <Footer.List>
              <Footer.ListItem>
                <Footer.Icon name="fas fa-phone-alt" social="true" />
                <Footer.Text>+919848066549</Footer.Text>
              </Footer.ListItem>
              <Footer.ListItem>
              ...
              <Footer.ListItem>
                ...
                <Footer.Text>devesh_homes@gmailcom</Footer.Text>
              </Footer.ListItem>
            </Footer.List>
          </Footer.Item>
          <Footer.Item>
      ...
      <Footer.Bottom>
        <Footer.Container>
          <Footer.Text>&copy; Devesh Homes. All Rights Reserved</Footer.Text>
        </Footer.Container>
      </Footer.Bottom>
    </Footer>
  );
